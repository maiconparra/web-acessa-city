  ...
  return (
    <div className={classes.root}>
      {/* <DenunciationsToolbar save={save} /> */}
       <ModeratorCoordinatorToolbar denunciationsSlect={denunciationsSlect} categories={categories}  filter={filter} filterAprove={filterAprove} />
      <div className={classes.content}>
        <ModeratorCoordinatorTable statusProgressDenunciation={statusProgressDenunciation} denunciations={denunciations} coodenadores={coodenadores} envioCoordenador={envioCoordenador}  envioDeny={envioDeny} envioProgress={envioProgress} enviorEncerrar={enviorEncerrar}/>
      </div>
